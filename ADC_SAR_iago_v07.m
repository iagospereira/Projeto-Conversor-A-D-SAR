...
%% Variáveis do modelo
n_bits = 4; % número de bits do conversor
Vref = 1.8;  % Referência de tensão
...
C = 30e-15;  % Capacitância unitária
...
%% Proceso de Conversão Single Ended
for i=1:sp
    bit = zeros(1,n_bits);
